    ...
    public partial class Form1 : Form
    {
        ...
        private void btnSelDir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmbDir.Items.Clear();
                foreach (string item in Directory.EnumerateDirectories(dlgFolder.SelectedPath, "*.*", SearchOption.AllDirectories))
                {
        ...
        private void cmbDir_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                lstBox.Items.Clear();
                foreach (string item in Directory.EnumerateFiles(cmbDir.SelectedItem.ToString(), cmbType.Text, SearchOption.TopDirectoryOnly))
                {
