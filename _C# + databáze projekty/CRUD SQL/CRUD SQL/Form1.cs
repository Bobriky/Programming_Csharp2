    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (listView1.SelectedItems.Count > 0)
            {
                ...
                string selectedTable = listBox2.SelectedItem.ToString();  // Získáme název tabulky
        ...
        private void connectButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (connection.State == ConnectionState.Open)
                {
                    ...
                    listBox1.Items.Clear();  // Vyčištění listBox2 (seznam databází)

                    // Čtení výsledků a přidání jednotlivých databází do listBox2
                    while (dataReader.Read())
                    {
                        listBox1.Items.Add(dataReader[0].ToString());  // Přidání názvu každé databáze do listBox2
                    }
        ...
        private void listBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                string selectedDatabase = listBox1.SelectedItem.ToString();  // Získání názvu vybrané databáze
                ...
                try
                {
                    ...
                    if (connection.State == ConnectionState.Open)
                    {
                        ...
                        MySqlCommand dataSQL = new MySqlCommand(commandSQL, connection);  // Vytvoření příkazu pro vykonání SQL dotazu
                        MySqlDataReader dataReader = dataSQL.ExecuteReader();  // Vykonání dotazu a získání výsledků
                        listBox2.Items.Clear();  // Vyčištění listBox1 (seznam tabulek)

                        // Čtení výsledků a přidání jednotlivých tabulek do listBox1
                        while (dataReader.Read())
                        {
                            listBox2.Items.Add(dataReader[0].ToString());  // Přidání názvu každé tabulky do listBox1
                        }
                        dataReader.Close();  // Zavření čtečky dat
                        connection.Close();  // Zavření připojení k databázi
                    }
